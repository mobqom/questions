...
func (r *questionRepository) FindRandomQuestion(ctx context.Context) (*domain.Question, error) {
	var question domain.Question
	if err := r.db.WithContext(ctx).Preload("Options").Order("RANDOM()").First(&question).Error; err != nil {
		return nil, err
	}
	return &question, nil
}
